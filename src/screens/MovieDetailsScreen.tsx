                ...
                <View style={styles.infoContainer}>
                    ...
                    <View style={styles.metaContainer}>
                        ...
                        {movie.added && (
                            <View style={styles.metaItem}>
                                ...
                                <Text style={styles.metaValue}>
                                    {new Date(parseInt(movie.added) * 1000).toLocaleDateString('pl-PL')}
                                </Text>
                            </View>
                        )}
                        {movie.container_extension && (
                            <View style={styles.metaItem}>
                                ...
                                <Text style={styles.metaValue}>{movie.container_extension.toUpperCase()}</Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.techInfo}>
                            <Text style={styles.techInfoText}>Stream ID: {movie.stream_id}</Text>
                            <Text style={styles.techInfoText}>Type: {movie.stream_type}</Text>
                            {movie.category_id && (
                                <Text style={styles.techInfoText}>Kategoria: {movie.category_id}</Text>
                            )}
                        </View>
                    </View>
