                ...
                <View style={styles.infoContainer}>
                    ...
                    <View style={styles.metaContainer}>
                        ...
                        {series.episode_run_time && (
                            <View style={styles.metaItem}>
                                ...
                                <Text style={styles.metaValue}>{series.episode_run_time} min</Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.techInfo}>
                            <Text style={styles.techInfoText}>Series ID: {series.series_id}</Text>
                            {series.category_id && (
                                <Text style={styles.techInfoText}>Kategoria: {series.category_id}</Text>
                            )}
                            {series.last_modified && (
                                <Text style={styles.techInfoText}>
                                    Ostatnia aktualizacja: {new Date(parseInt(series.last_modified) * 1000).toLocaleDateString('pl-PL')}
                                </Text>
                            )}
                        </View>
                    </View>
                    ...
                    <View style={styles.actionsContainer}>
                        ...
                        >
                            <Text style={styles.actionButtonText}>❤️ Dodaj do ulubionych</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    {series.youtube_trailer && (
                        <TouchableOpacity
                            ...
                            onPress={() => console.log('Play trailer:', series.youtube_trailer)}
                        >
